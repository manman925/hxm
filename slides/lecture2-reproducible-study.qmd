...
```bash
# 克隆课程仓库
git clone https://github.com/D2RS-2025spring.git
...
- 我的个人网站：[https://d2rs.bio-spring.top](https://d2rs.bio-spring.top)
- GitHub Pages：[https://d2rs-2025spring.github.io](https://d2rs-2025spring.github.io)
