...
1.  R、Python 等编程语言
    1.  tidyverse 软件包
    2.  bioconductor 软件包
2.  Git 和 GitHub/Gitee
3.  Conda/pip
4.  Quarto 和 R Mardown/JupyterLab
...
1.  操作系统和环境变量
    1.  Linux系统的设计哲学
        ...
        4.  软件体系
            ...
            3.  库文件
2.  应用软件分发体系
    1.  R：CRAN/Bioconductor
    2.  Python: pip/Conda
    3.  Ubuntu: APT
    4.  源代码：GitHub/SourceForge
...
本课程采用项目驱动的教学方式。每次课程围绕一个独立但相互关联的项目展开。课程内容以“项目”为单位进行组织。所有项目包括：
